...
const roster = () => {
  return (
    <section>
      <h1 className='text-2xl md:text-5xl sm:text-6xl font-[800] underline decoration-secondary underline-offset-[12px] text-white space-x-2 p-6 font-oct'>03 - ROSTER</h1>
      <div className='p-6'>
