    ...
    <section className='h-screen w-screen'>
      <div className=' h-full w-full'>
        ...
        <div className='relative text-white'>
          <h1 className='text-2xl md:text-5xl sm:text-6xl font-[800] underline decoration-secondary underline-offset-[12px] text-white space-x-2 p-6 tracking-widest'>02 - PROLOGUE</h1>
